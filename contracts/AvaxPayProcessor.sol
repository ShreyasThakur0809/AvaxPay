...
/**
 * @title AvaxPayProcessor V2
 * @dev Process payments in native AVAX and ERC-20 tokens
 * @notice Core payment processor for AvaxPay platform
 */
contract AvaxPayProcessor {
    ...
    /**
     * @dev Process native AVAX payment
